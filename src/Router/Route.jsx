...
import { user, userIndex, account, setUserName, address, addAddress, changePassword, balance, giftMoney, integral, memberCard, exchangeCard, buyRecord, serviceCenter } from './user.jsx';
